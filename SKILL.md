---
name: solo-toolkit
description: "Solo founder toolkit — design intelligence + business analytics + market research + startup metrics. 67 styles, 96 palettes, 57 font pairings, 25 charts, 13 stacks (React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui). Actions: plan, build, create, design, implement, review, fix, improve, optimize, enhance, refactor, check UI/UX code. Projects: website, landing page, dashboard, admin panel, e-commerce, SaaS, portfolio, blog, mobile app, .html, .tsx, .vue, .svelte. Elements: button, modal, navbar, sidebar, card, table, form, chart. Styles: glassmorphism, claymorphism, minimalism, brutalism, neumorphism, bento grid, dark mode, responsive, skeuomorphism, flat design. Topics: color palette, accessibility, animation, layout, typography, font pairing, spacing, hover, shadow, gradient. Integrations: shadcn/ui MCP for component search and examples. Business: analyze sales data, revenue report, business performance, identify weak areas, CSV analysis, strategic recommendations, business analytics. Market: research this market, how big is this market, TAM SAM SOM, competitive analysis, market trends, customer persona, industry analysis. Startup: key startup metrics, SaaS metrics, CAC and LTV, unit economics, burn multiple, rule of 40, marketplace metrics, MRR, ARR, churn, retention, payback period. Workflows: debug this, fix this bug, investigate error, root cause analysis, review this PR, code review, pre-landing review, check my diff, ship, deploy, push to main, create a PR, merge and push, qa, QA, test this site, find bugs, test and fix, brainstorm this, I have an idea, office hours, is this worth building, think bigger, expand scope, strategy review, review the architecture, engineering review, lock in the plan, review the design plan, design critique, design system, brand guidelines, create DESIGN.md, audit the design, visual QA, design polish, weekly retro, what did we ship, update the docs, sync documentation, be careful, safety mode, freeze, restrict edits, guard mode, unfreeze."
---
