...
description: "Use to create Excalidraw diagrams for workflows, system architecture, process maps, user journeys, product flows, decision trees, and visual explanations."
---
...
If the diagram is too large or too uncertain to complete in one pass:

- build it section by section
- validate each section visually before moving on
- prefer accurate partial completion over speculative full coverage

Principle: **a technical diagram should teach accurately before it impresses visually.**
